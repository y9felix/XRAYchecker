...
1.  **Настройки сортировки отфильтрованных прокси** — для более гибкого управления результатами, сейчас прокси сортируются просто по пингу.
2.  **Встроенный спидтест** — чтобы чекать не только отклик, но и реальную скорость канала.
